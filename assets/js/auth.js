...
// Custom auth model: no Supabase Auth session, just a small session
// object saved locally after a successful youth_login / admin_login
// RPC call. "Remember me" checked -> localStorage (persists after the
// browser is closed). Unchecked -> sessionStorage (cleared on close).
// =====================================================================
