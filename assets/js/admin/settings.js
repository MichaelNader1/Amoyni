(function () {
  ...
  async function load() {
    try {
      ...
      document.getElementById("s-scan_timeout_seconds").value = s.scan_timeout_seconds || 60;
  ...
  document.getElementById("settings-form").addEventListener("submit", async function (e) {
    ...
    try {
      await Promise.all([
        ...
        window.AmoyniAPI.call("update_app_setting", { p_admin_id: admin.admin_id, p_key: "scan_timeout_seconds", p_value: JSON.stringify(parseInt(document.getElementById("s-scan_timeout_seconds").value, 10)) }),
